...
var colors = [Color8(224,49,49),Color8(255,146,43),Color8(255,212,59),Color8(148,216,45),Color8(34,139,230),Color8(132,94,247),Color8(190,75,219),Color8(134,142,150)]
...
func _physics_process(_delta):
	if dying and not $Confetti.emitting and not tween:
		...
		Global.color_distance = Global.color_position.distance_to(global_position)
